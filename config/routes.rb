Rails.application.routes.draw do
  ...
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('CW_API_ONLY_SERVER', false))
    ...
    # Página pública de assinatura de contratos
    get '/contracts/sign/:token', to: 'contracts#sign', as: 'contract_sign_page'
  end
        ...
        scope module: :accounts do
          ...
          resources :contracts do
            ...
            member do
              ...
              post :duplicate
              get :download_pdf
              post 'resend/:signer_id', action: :resend_to_signer, as: :resend_to_signer
            end
          end
  ...
  namespace :public, defaults: { format: 'json' } do
    namespace :api do
      namespace :v1 do
        ...
        # Contratos - Assinatura pública
        resources :contracts, only: [], param: :token do
          member do
            get :show, action: :show, as: :view
            post :sign
            post :refuse
            get :download
          end
