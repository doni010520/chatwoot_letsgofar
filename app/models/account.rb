...
class Account < ApplicationRecord
  ...
  has_many :broadcast_campaigns, dependent: :destroy_async
  has_many :broadcast_recipients, dependent: :destroy_async
  has_many :canned_responses, dependent: :destroy_async
  has_many :categories, dependent: :destroy_async, class_name: '::Category'
  has_many :contacts, dependent: :destroy_async
  has_many :contracts, dependent: :destroy_async
  has_many :contract_templates, dependent: :destroy_async
  ...
  has_many :agent_tasks, dependent: :destroy_async
