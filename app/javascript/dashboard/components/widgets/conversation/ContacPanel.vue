...
import ScheduledMessagesList from 'dashboard/components/widgets/conversation/ScheduledMessagesList.vue';
    ...
    <div class="px-2 pb-8 list-group">
      ...
      <div class="crm-sidebar-section">
        <AccordionItem
          ...
          @toggle="value => toggleSidebarUIState('is_scheduled_messages_open', value)"
        >
